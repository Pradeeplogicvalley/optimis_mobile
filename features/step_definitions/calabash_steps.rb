...
Given(/^click record an action$/) do
  ...
  query("android.widget.EditText id:'edit_search'", setText:"9696788")
   ...
   performAction("click_on_text", 'Case Holdings')
    sleep(3)
  performAction("click_on_text", '969678')
  sleep(3)
end
...
When(/^enter notes$/) do
  ...
  touch("android.widget.TextView id:'doors_count'")
    sleep(3)
  query("android.widget.EditText id:'edit_search'", setText:"9696790")
     sleep(3)
   touch("android.widget.TextView id:'case_list_defaulter_name'")
     sleep(3)
  performAction("click_on_text", '969679')
      sleep(3)
  performAction("click_on_text", 'Record a non visit action')
    sleep(3)
  performAction("click_on_text", 'Yes')
...
Given(/^click record action$/) do
  ...
  touch("android.widget.TextView id:'doors_count'")
    sleep(3)
  query("android.widget.EditText id:'edit_search'", setText:"9706247")
  sleep(3)
   touch("android.widget.TextView id:'case_list_defaulter_name'")
     sleep(3)
  performAction("click_on_text", '970624')
  sleep(3)
...
Given(/^Record returned action for visit action$/) do
  ...
  touch("android.widget.TextView id:'doors_count'")
    sleep(3)
  query("android.widget.EditText id:'edit_search'", setText:"9712034")
      sleep(3)
  sleep(3)
   touch("android.widget.TextView id:'case_list_defaulter_name'")
     sleep(3)
  performAction("click_on_text", '971203')
  sleep(3)
  performAction("click_on_text", 'Record a visit action')
  sleep(3)
    performAction("click_on_text", 'Yes')
...
Given(/^Record goods removed for visit action$/) do
  ...
  touch("android.widget.TextView id:'doors_count'")
    sleep(3)
  query("android.widget.EditText id:'edit_search'", setText:"9718059")
  sleep(3)
   touch("android.widget.TextView id:'case_list_defaulter_name'")
     sleep(3)
  performAction("click_on_text", '971805')
    sleep(3)
    performAction("click_on_text", 'Record a visit action')
  sleep(3)
    performAction("click_on_text", 'Yes')
...
Given(/^visit action left letter$/) do
 ...
 touch("android.widget.TextView id:'doors_count'")
   sleep(3)
  query("android.widget.EditText id:'edit_search'", setText:"9718109")
   sleep(3)
   touch("android.widget.TextView id:'case_list_defaulter_name'")
     sleep(3)
  performAction("click_on_text", '971810')
  sleep(3)
    performAction("click_on_text", 'Record a visit action')
  sleep(3)
    performAction("click_on_text", 'Yes')
